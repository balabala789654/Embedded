...
Graph_Data G5, G8, G10, G11, G12, G21, G22, G23, G24, G25, G26, G40, G41, G42, G43, G44,G46;
Graph_Data G45;//请求射击标志
Float_Data G6;
...
void ui_task(void  *pvParameters)
{
    ...
    memset(&SUPER, 0, sizeof(SUPER));
		memset(&G46,0,sizeof(G46));

//    Rectangle_Draw(&G46, "110",UI_Graph_ADD,0,UI_Color_Yellow,4, 900, 405, 400, 200);
    ...
    Line_Draw(&G10, "081", UI_Graph_ADD, 0, UI_Color_White, 3, 500, 0, 650, 300); //底盘可过位置左标志位
    Line_Draw(&G11, "082", UI_Graph_ADD, 0, UI_Color_White, 3, 1340, 0, 1180, 300); //底盘可过位置右标志位
//    Line_Draw(&G12, "083", UI_Graph_ADD, 0, UI_Color_White, 3, 800, 177, 1120, 177); //能量机关击打标志位
//    Rectangle_Draw(&G45,"110",UI_Graph_Change,0,UI_Color_White,1,890,415,1030,290);//视觉辅助射击
    //状态标志(实心方块)
...
//    Line_Draw(&G5, "107", UI_Graph_ADD, 1, UI_Color_Orange, 15, 700, 100, (Super_power.volt - 12000) / 10 + 700, 100); //超级电容——进度条
...
//            Line_Draw(&G5, "107", UI_Graph_Change, 1, UI_Color_Orange, 15, 700, 100, (superpower_x - 12000) / 10 + 700, 100);
