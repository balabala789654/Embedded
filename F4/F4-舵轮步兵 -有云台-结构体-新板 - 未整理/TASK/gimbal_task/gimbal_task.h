...
#define INFANTRY_ID   4
    ...
    #define 	PITCH_MAX   		 25
#elif (INFANTRY_ID==4)
    #define Glimbal_Yaw_Offset  							(3438)
    #define Glimbal_Yaw_Offset_Back 		      3440
    #define Glimbal_Pitch_Offset 							5585
    #define PITCH_TURN     									  -1
    #define PWM  															17915
		#define 	PITCH_MIN  			-28
    #define 	PITCH_MAX   		 20
...
#define PITCH_INIT_PID_KI						0.01f
...
//手动模式
#define PITCH_MANUAL_ANGLE_PID_KP		25.0f
#define PITCH_MANUAL_ANGLE_PID_KI		0.1f
#define PITCH_MANUAL_ANGLE_PID_KD	4.0f
#define PITCH_MANUAL_SPEED_PID_KP 		200.0f
#define PITCH_MANUAL_SPEED_PID_KI			0.0f
#define PITCH_MANUAL_SPEED_PID_KD		0.0f
//自瞄模式
