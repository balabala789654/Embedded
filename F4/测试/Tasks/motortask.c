...
void task1_task(void *pvParameters)
{
	...
	while(1)
	{
		...
		M3508_control.M3508[0].pid_set_speed=1000;
		M3508_control.M3508[1].pid_set_speed=1000;
		M3508_control.M3508[2].pid_set_speed=1000;
		M3508_control.M3508[3].pid_set_speed=1000;
		...
		motor_send_6020(pid_control.M3508_PID[0].out,pid_control.M3508_PID[1].out,pid_control.M3508_PID[2].out,pid_control.M3508_PID[3].out);
