...
//				M3508_control.M3508[3].pid_set_speed=-vx;
		...
		{
			y = ros_control.motor_rpm_vy;
			x = ros_control.motor_rpm_vx;
			z = ros_control.motor_rpm_vz;
			
			vy = y*cos(PI/4)+x*sin(PI/4);
			vx = -y*sin(PI/4)+x*cos(PI/4);
			vz = z;
			
			M3508_control.M3508[0].pid_set_speed=-vy-vz;
			M3508_control.M3508[2].pid_set_speed=vy-vz;
			
			M3508_control.M3508[1].pid_set_speed=vx-vz;
			M3508_control.M3508[3].pid_set_speed=-vx-vz;
		}
